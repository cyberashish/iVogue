export const PHONE_BRAND = [
  {
    ...
    brand: "Apple",
    model: [
      {key:'Apple1', badge: true, modelName: "Apple iphone 15",href:"category/mobile-covers", brand: "Apple", },
      {key:'Apple2', badge: true, modelName: "Apple iphone 15 Pro Max",href:"category/mobile-covers", brand: "Apple", },
      {key:'Apple3', badge: true, modelName: "Apple iphone 15 Pro",href:"category/mobile-covers", brand: "Apple", },
      {key:'Apple4', badge: false, modelName: "Apple iphone 14",href:"category/mobile-covers", brand: "Apple", },
      {key:'Apple5', badge: false, modelName: "Apple iphone 14 Pro Max",href:"category/mobile-covers", brand: "Apple", },
    ],
  },
  { key: "brand2", brand: "Samsung", model: [
    {key:'Samsung1', badge: true, modelName: "Samsung Galaxy S24 Ultra",href:"category/mobile-covers",brand: "Samsung" },
    {key:'Samsung2', badge: true, modelName: "Samsung Galaxy A52S",href:"category/mobile-covers",brand: "Samsung" },
    {key:'Samsung3', badge: true, modelName: "Samsung Galaxy S24 Plus",href:"category/mobile-covers",brand: "Samsung" },
    {key:'Samsung4', badge: false, modelName: "Samsung Galaxy S24",href:"category/mobile-covers",brand: "Samsung" },
    {key:'Samsung5', badge: false, modelName: "Samsung Galaxy S23 FE",href:"category/mobile-covers",brand: "Samsung" },
    {key:'Samsung6', badge: false, modelName: "Samsung Galaxy A54",href:"category/mobile-covers",brand: "Samsung" },
  ] },
