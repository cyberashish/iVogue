...
const Footer = () => {
  ...
  return (
    <>
            ...
            <div className='col-lg-8 col-12'>
              <div className='row'>
                <div className='col-md-4 pe-md-16 text-sm-start text-center'>
                  <h4 className='text-white fs-22 pb-2 mb-0 text-uppercase'>Company</h4>
                  ...
                  <ul className='footer-links d-flex flex-column gap-sm-4 gap-3 list-unstyled mb-0 ms-auto mb-md-0 mb-7'>
                    {Company.map((nav_link) => {
                      return (
                        <li key={nav_link.key} className='fs-5 fw-light font-graphik' ><Link href={nav_link.href} as={`${baseurl}/${nav_link.href}`} className='text-decoration-none fw-light text-white'>{nav_link.label}</Link></li>
                      )
                    })}
                  </ul>
                </div>
                <div className='col-md-4 text-sm-start text-center'>
                  <h4 className='text-white fs-22 pb-2 mb-0 text-uppercase'>Products</h4>
                  <hr className='w-50 mt-0 mb-sm-4 mb-3 border-top-2 border-2 border-primary  mx-md-0 mx-auto'></hr>
                  <ul className='footer-links d-flex flex-column gap-sm-4 gap-3 list-unstyled mb-0 ms-auto  mb-md-0 mb-7'>
                ...
                <div className='col-md-4 text-sm-start text-center'>
                  <h4 className='text-white fs-22 pb-2 mb-0 text-uppercase'>Info</h4>
                  <hr className='w-50 mt-0 mb-sm-4 mb-3 border-top-2 border-2 border-primary  mx-md-0 mx-auto '></hr>
                  <ul className=' d-flex flex-column gap-sm-4 gap-3 list-unstyled mb-0 ms-auto mb-0'>
                    <li className='fw-light text-white fs-5 font-graphik'>0000-0000-000</li>
                    <li className='fw-light text-white fs-5 font-graphik'> xyz@logoname.com</li>
                    <li className='fw-light text-white fs-5 font-graphik'>456 Sunshine Avenue Palm City New Delhi, India 110001</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div className='footer-bottom bg-bgfooter py-3'>
