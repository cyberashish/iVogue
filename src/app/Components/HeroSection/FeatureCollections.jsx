    ...
    return (
        <>
            <div className='container pt-sm-12 pt-7'>
                <h2 className='text-center fw-semibold mb-10 fs-12 text-uppercase'>Feature Collection</h2>
                <div className='row'>
                    {CollectionData.map((featurecoll) => {
                        return (
                            <div className='col-md-4 mb-sm-0 mb-6' key={featurecoll.key}>
                                <Link href={`/mobile-cases/brand-identifier`} >
                                    <div className='position-relative hover-img overflow-hidden collection-box'>
                                        ...
                                        />
                                        <div className='badge bg-primary-subtle rounded-0 text-dark fw-normal fs-4 px-3 position-absolute z-1 tag rounded-pill'>{featurecoll.tag}</div>
                                        <div className='position-absolute  title w-100'>
                                        <h3 className='fs-8 fw-semibold text-dark-light mb-0 pb-3 text-uppercase'>{featurecoll.name}</h3>
                    ...
                    <div className='d-flex justify-content-center mt-sm-8 mt-6 mb-4'>
                        <button className="btn btn-outline-indigo text-uppercase px-12 mt-2 py-2 w-100 fw-normal w-auto" onClick={()=>{
