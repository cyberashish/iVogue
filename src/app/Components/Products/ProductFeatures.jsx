...
const ProductFeatures = () => {
  return (
    <div>
      <h2 className='text-black fs-54 fw-bold letter text-center mb-53'>Why Choose?</h2>
      <div className="container">
        <div className="row">
            <div className="col-lg-4 align-items-stretch justify-content-between d-flex flex-column ">
