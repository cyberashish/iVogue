      ...
      <div className="container mt-52">
        ...
        <div className="row  ">
          <div className="col-lg-4 justify-content-center  align-items-center">
            <div className=" flex-column gap-2 review-rating px-9 text-center  ">
               ...
               <div className="d-flex py-13 px-5 bg-light-primary rounded-bottom-3 align-items-center align-items-center  justify-content-between  ">
                ...
                <div className="d-flex flex-column ">
                  ...
                  <span className='fw-bold fs-4 text-gray-emphasis lh-1'>a week ago</span>
                     ...
                     <button className='btn btn-primary rounded-0 align-self-center d-flex align-items-center  '>
                    <Icon icon='material-symbols-light:star' className='text-white fs-6' />
                    <span className='fs-3 align-self-center '>5</span>
                    </button>
                     </div>
               </div>
          </div>
